...
export async function POST(request: NextRequest) {
  try {
    ...
    if (transporter && emailData.customerEmail) {
      try {
        ...
        return NextResponse.json({
          success: true,
          solicitudId,
          message: "Pago móvil procesado correctamente, pero hubo un problema enviando el email",
      ...
      return NextResponse.json({
        success: true,
        solicitudId,
        message: "Pago móvil procesado correctamente, pero la configuración de email no está completa",
        data: {
          id: solicitudId,
          status: "pending_verification",
          customerName: emailData.customerName,
    ...
    return NextResponse.json({
      success: true,
      solicitudId,
      message: "Pago móvil procesado correctamente y emails enviados",
      data: {
        id: solicitudId,
        status: "pending_verification",
        customerName: emailData.customerName,
